...
class Settings(BaseSettings):
    """Centralized Sentinel configuration loaded from environment variables."""
    ...
    # real = use configured external providers
    # mock = use deterministic local providers for automated tests
    ...
    # Optional prebuilt proxy connection strings retained for compatibility
